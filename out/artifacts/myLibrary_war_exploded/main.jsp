                    ...
                    <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            ...
                            <td colspan="2" valign="top">
                                <marquee><h3 style="margin:20px 0 10px 10px;">你好，我的朋友</h3>  </marquee>
                            </td>
                        </tr>
                            ...
                            <td valign="top">
                                <table width="100%" height="230" border="0" cellpadding="0" cellspacing="0" style="border: 1px solid #CCCCCC;">
                                    ...
                                    <tr><td height="186" valign="top"  style="font-size: 20px; font-family:'隶书'; font-weight: bolder;">
                                       ...
                                       <a href="login.html">
                                        <img src="Images/echart2.png" width="700px" height="500px"/>
                                        </a>
                                    </td>
                                    <td>&nbsp;&nbsp;</td>
                                    <td height="102" valign="top">
                                        <a href="login.html">
                                        <img src="Images/echart.png" width="700px" height="500px"/>
                                        </a>
                                    </td></tr>
                        ...
                        <tr>
                            ...
                            <td width="51%" class="left_txt">
                               <img src="./Images/icon_mail.gif" width="16" height="11"> 查看学长 <br />
