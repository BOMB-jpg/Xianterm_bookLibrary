...
<%@ page import="com.tree.book.bean.Record" %>
            ...
            <table width="100%" border="0" align="center" cellpadding="0" cellspacing="0">
                        ...
                        <fieldset>
                            ...
                            <table width="100%" border="1" class="cont"  >
                                ...
                                <tr>
                                    ...
                                    <td width="17%"><input class="text" type="text" name="memberId" value="${member.name}"  disabled/></td>
                                        ...
                                        <table width="100%"  class="cont tr_color">
                                            ...
                                            <c:if test="${records==null}">
                                                 <tr  align="center" class="id">
                                                     <td colspan="8" align="center"> <h2> 暂时无数据显示</h2></td>
                                                 </tr>
                                            </c:if>
                ...
                <tr>
                    ...
                    <td width="51%" class="left_txt">
                        <img src="./Images/icon_mail.gif" width="16" height="11">  服务商：TreeSoundStudio<br />
                    </td>
                    <td>&nbsp;</td><td>&nbsp;</td>
                </tr>
            </table>
